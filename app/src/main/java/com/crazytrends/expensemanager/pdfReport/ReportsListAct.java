...
public class ReportsListAct extends BaseActivityRecyclerBinding implements OnClickListener, PermissionCallbacks, RationaleCallbacks {
    ...
    public void setBinding() {
        this.binding = (ActivityReportsListBinding) DataBindingUtil.setContentView(this, R.layout.act_reports_list);
            ...
            public void doInBackground() {
                try {
                    ...
                    for (int i = 0; i < listFiles.length; i++) {
                        ...
                        ReportsListAct.this.list.add(listFiles[i]);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void setRecycler() {
        ...
        this.binding.recycler.setAdapter(new ReportPdfAdapter(this.context, this.list, new RecyclerItemClick() {
            public void onClick(int i, int i2) {
                ReportsListAct.this.setViewVisibility();
            }
        }));
    }
