...
public class BackupTransferGuidAct extends AppCompatActivity implements OnClickListener {
    ...
    private class MyCustomizedWebClient extends WebViewClient {
        ...
        public void onPageFinished(WebView webView, String str) {
            BackupTransferGuidAct.this.binding.progress.setVisibility(8);
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.binding = (ActivityBackupTransferGuidBinding) DataBindingUtil.setContentView(this, R.layout.act_backup_transfer_guid);
        setToolbar();
        setOnClicks();
        initMethods();
    }
