...
public class RestoreListActivity extends BaseActivityRecyclerBinding implements PermissionCallbacks, RationaleCallbacks {
    ...
    public void restoreItem(final int i) {
        ...
        AppConstants.showRestoreDialog(this.context, getString(R.string.app_name), sb.toString(), true, true, getString(R.string.restore), getString(R.string.cancel), new TwoButtonDialogListener() {
            public void onOk() {
                ...
                RestoreListActivity.this.backupData(((RestoreRowModel) RestoreListActivity.this.model.getArrayList().get(i)).getPath(), false);
            }

            public void onCancel() {
                RestoreListActivity.this.isResultOK = true;
                RestoreListActivity.this.backupData(((RestoreRowModel) RestoreListActivity.this.model.getArrayList().get(i)).getPath(), true);
            }
        });
    }
