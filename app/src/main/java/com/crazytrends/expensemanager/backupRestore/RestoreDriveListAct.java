...
public class RestoreDriveListAct extends BaseActivityRecyclerBinding {
    ...
    public void setBinding() {
        binding = (ActivityRestoreListBinding) DataBindingUtil.setContentView(this, R.layout.act_restore_list);
