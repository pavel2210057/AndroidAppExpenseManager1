...
public class AddEditDemoAct extends BaseActivityBinding {
    ...
    public void setBinding() {
        this.binding = (ActivityDemoAddEditBinding) DataBindingUtil.setContentView(this, R.layout.act_demo_add_edit);
    ...
    public void deleteItem() {
        ...
        AppConstants.showTwoButtonDialog(this.context, getString(R.string.app_name), sb.toString(), true, true, getString(R.string.delete), getString(R.string.cancel), new TwoButtonDialogListener() {
            ...
            public void onOk() {
                try {
                    AddEditDemoAct.this.db.demoDao().delete(AddEditDemoAct.this.model);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                AddEditDemoAct.this.openItemList(true);
            }
        });
    }
