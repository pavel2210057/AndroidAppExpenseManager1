...
public class PaymentModeListAct extends BaseActivityRecyclerBinding {
    ...
    public void setBinding() {
        this.binding = (ActivityPaymentModeListBinding) DataBindingUtil.setContentView(this, R.layout.act_payment_mode_list);
    ...
    public void fillData() {
        new BackgroundAsync(this.context, true, "", new OnAsyncBackground() {
            ...
            public void doInBackground() {
                PaymentModeListAct.this.fillFromDB();
            }

            public void onPostExecute() {
                PaymentModeListAct.this.notifyAdapter();
            }
    ...
    public void setRecycler() {
        ...
        this.binding.recycler.setAdapter(new ModeAdapter(this.context, true, this.model.getArrayList(), new RecyclerItemClick() {
            public void onClick(int i, int i2) {
                if (i2 == 2) {
                    PaymentModeListAct.this.deleteItem(i);
                } else {
                    PaymentModeListAct.this.showNewCatList(i);
                }
            }
        }));
    }
    ...
    public void deleteItem(final int i) {
        ...
        AppConstants.showTwoButtonDialog(this.context, getString(R.string.app_name), sb.toString(), true, true, getString(R.string.delete), getString(R.string.cancel), new TwoButtonDialogListener() {
            ...
            public void onOk() {
                PaymentModeListAct.this.deleteCategory(i);
            }
        });
    }
    ...
    public void deleteCategory(final int i) {
        new BackgroundAsync(this.context, true, "", new OnAsyncBackground() {
            ...
            public void doInBackground() {
                try {
                    PaymentModeListAct.this.db.transactionDao().deleteAllMode(((ModeRowModel) PaymentModeListAct.this.model.getArrayList().get(i)).getId());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            public void onPostExecute() {
                try {
                    PaymentModeListAct.this.db.modeDao().delete((ModeRowModel) PaymentModeListAct.this.model.getArrayList().get(i));
                } catch (Exception e) {
                    e.printStackTrace();
                }
                PaymentModeListAct.this.model.getArrayList().remove(i);
                PaymentModeListAct.this.notifyAdapter();
            }
        }).execute(new Object[0]);
    }
    ...
    public void setNewCatDialog() {
        ...
        this.dialogNewCatBinding.btnCancel.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                try {
                    PaymentModeListAct.this.dialogNewCat.dismiss();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        this.dialogNewCatBinding.btnOk.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                long j = 0;
                long j2;
                if (PaymentModeListAct.this.isValidNewCat(PaymentModeListAct.this.dialogNewCatBinding)) {
                    PaymentModeListAct.this.catRowModel.setName(PaymentModeListAct.this.dialogNewCatBinding.etName.getText().toString().trim());
                    Exception e;
                    try {
                        PaymentModeListAct.this.catRowModel.getName().trim();
                        if (PaymentModeListAct.this.selectedCatPos != -1) {
                            try {
                                j = (long) PaymentModeListAct.this.db.modeDao().update(PaymentModeListAct.this.catRowModel);
                            } catch (Exception e1) {
                                e1.printStackTrace();
                                j = 0;
                            }
                            try {
                                if (PaymentModeListAct.this.searchText == null || PaymentModeListAct.this.searchText.length() <= 0) {
                                    PaymentModeListAct.this.model.getArrayList().set(PaymentModeListAct.this.selectedCatPos, PaymentModeListAct.this.catRowModel);
                                } else if (PaymentModeListAct.this.catRowModel.getName().toLowerCase().contains(PaymentModeListAct.this.searchText.toLowerCase())) {
                                    PaymentModeListAct.this.model.getArrayList().set(PaymentModeListAct.this.selectedCatPos, PaymentModeListAct.this.catRowModel);
                                } else {
                                    PaymentModeListAct.this.model.getArrayList().remove(PaymentModeListAct.this.selectedCatPos);
                                }
                                PaymentModeListAct.this.listMain.set(PaymentModeListAct.this.selectedCatPos, PaymentModeListAct.this.catRowModel);
                            } catch (Exception e2) {
                                e = e2;
                                e.printStackTrace();
                                if (j > 0) {
                            ...
                            try {
                                j2 = PaymentModeListAct.this.db.modeDao().insert(PaymentModeListAct.this.catRowModel);
                            } catch (Exception e4) {
                                e4.printStackTrace();
                                j2 = 0;
                            }
                            if (PaymentModeListAct.this.searchText == null || PaymentModeListAct.this.searchText.length() <= 0) {
                                PaymentModeListAct.this.model.getArrayList().add(PaymentModeListAct.this.catRowModel);
                            } else if (PaymentModeListAct.this.catRowModel.getName().toLowerCase().contains(PaymentModeListAct.this.searchText.toLowerCase())) {
                                PaymentModeListAct.this.model.getArrayList().add(PaymentModeListAct.this.catRowModel);
                            }
                            PaymentModeListAct.this.listMain.add(PaymentModeListAct.this.catRowModel);
                            if (j > 0) {
                            }
                            PaymentModeListAct.this.dialogNewCat.dismiss();
                        }
    ...
    private void setSearch() {
        this.binding.includedToolbar.search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String str) {
                PaymentModeListAct.this.updateList(str);
                return false;
            }
        });
    }
