...
public class MainActivityPager extends BaseActivityBinding implements OnFragmentInteractionListener {
        ...
        this.binding.tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() == 0) {
                    MainActivityPager.this.setToolbarAndMenu(MainActivityPager.this.getString(R.string.app_name), false);
                }
            }
        });
    }
