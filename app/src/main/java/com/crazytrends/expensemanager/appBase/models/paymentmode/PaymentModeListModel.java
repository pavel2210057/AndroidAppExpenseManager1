package com.crazytrends.expensemanager.appBase.models.paymentmode;
...
public class PaymentModeListModel extends BaseObservable {
    private ArrayList<ModeRowModel> arrayList;
    private String noDataDetail;
    private int noDataIcon;
    private String noDataText;

    @Bindable
    public ArrayList<ModeRowModel> getArrayList() {
        return this.arrayList;
    }

    public void setArrayList(ArrayList<ModeRowModel> arrayList2) {
