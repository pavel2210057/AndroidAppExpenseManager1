...
public class SplashAct extends AppCompatActivity {
    ...
    SplashAct splash_activity;
    public WeakReference<SplashAct> splash_activityWeakReference;
    ...
    public void openMainActivity() {
        try {
            if (!AppPref.IsTermsAccept(context)) {
                startActivity(new Intent(this, ExpenseDisclosureAct.class));
            } else if (!AppPref.isFirstLaunch(context)) {
                startActivity(new Intent(context, MainAct.class));
            } else {
                startActivity(new Intent(context, MainAct.class));
            }
            finish();
